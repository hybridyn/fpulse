...
Yes — every cloud provider in **Insights → AI Provider** uses **bring-your-own-key**. F-Pulse never proxies your tokens through Hybridyn.
...
The Contributor License Agreement grants Hybridyn the right to relicense your contribution. This is the standard open-core pattern; without it we can't accept code.
