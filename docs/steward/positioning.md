...
A short, shareable summary of what the Steward is and why it matters.
Written for investors, partners, recruiters, and anyone asking
"what's the actual differentiator here?" — separate from the
...
| 1.2     | **Autopsy**        | Failure RCA — uses the Memory Layer to match past incidents      |
| 1.3     | **Foreseer**       | Volume + schema-drift anomaly detection                          |
| 1.4     | **Curator**        | Distills `EPULSE_RUNBOOK.md` from approved lessons               |
| 2.0     | **Optimizer**      | Cost + performance recommendations                               |
