...
The actual tool count derived from the codebase is **26 tools** organised in three tiers. The SOURCE OF TRUTH is the registry in `backend/fpulse/ai/tools/`. The breakdown:
