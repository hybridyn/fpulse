...
> **Before you file:** could the existing **Python transform** or **SQL transform** node solve this? Those are catch-alls that don't require us to ship anything new. See [docs/extend/build-a-node.md](https://github.com/hybridyn/fpulse/blob/main/docs/extend/build-a-node.md). If you've tried them and they're not the right shape, please continue.
