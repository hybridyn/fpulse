...
_OSS_FREE_INCLUDES = [
    ...
    "a broad node palette across source / transform / combine / control-flow / action / AI categories (the exact live list is injected below) — most OSS, a few Plus-only (CDC, Vector Sink, JDBC dialect registry)",
...
_OSS_FREE_EXCLUDES = [
    ...
    "CDC source, Vector DB sinks, JDBC dialect registry (Plus)",
