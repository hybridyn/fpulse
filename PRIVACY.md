...
All data is stored on your install's filesystem under `FPULSE_DATA_DIR` (default `./data`). Nothing in this list is transmitted to Hybridyn Data Labs or any third party.
...
- **No phone-home.** F-Pulse does not contact Hybridyn Data Labs or any third-party server during boot, upgrade, or normal operation.
